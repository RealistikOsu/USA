...
function cheesegullBeatmapsetFromResponse(response: _CheesegullBeatmapset): CheesegullBeatmapset {
    return {
        id: response.SetID,
        beatmaps: response.ChildrenBeatmaps.map(beatmap => cheesegullBeatmapFromResponse(beatmap)),
...
function cheesegullBeatmapFromResponse(response: _CheesegullBeatmap): CheesegullBeatmap {
    return {
